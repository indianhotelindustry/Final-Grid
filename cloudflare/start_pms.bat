@echo off
REM ============================================================
REM  FinalGrid — Full Startup Script
...
echo.
echo  ====================================
echo    FinalGrid — Startup
echo  ====================================
echo.

REM 1. Start Flask PMS in background
echo  [1/2] Starting PMS server...
start "FinalGrid Server" cmd /k "cd /d %PMS_DIR% && %VENV%\python.exe run.py"
timeout /t 5 /nobreak >nul

REM 2. Start Cloudflare Tunnel
echo  [2/2] Starting Cloudflare Tunnel...
start "FinalGrid Cloudflare Tunnel" cmd /k "cloudflared tunnel --config "%~dp0config.yml" run"
